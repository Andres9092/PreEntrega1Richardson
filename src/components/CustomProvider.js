...
const CustomProvider = (props) => {         // 1) Creo ESTE archivo con componente CustomProvider.
  ...
  console.log("cantidadCart :", cantidadCart)
    ...
    return (  
      ...
      <Provider value = {{cantidadCart}}> {/* 5) Se usa el 'Provider' dentro del return. Le provee a la parte de la aplicacion que englobe el CustomProvider, del valor del Contexto, a traves de 'value'.*/}
